...
namespace Bomberman
{
	...
	{
		if (e->KeyCode == Keys::W || e->KeyCode == Keys::Up && Winform::upecino->direccion == Arriba)
			Winform::upecino->Detener();
		else if (e->KeyCode == Keys::S || e->KeyCode == Keys::Down && Winform::upecino->direccion == Abajo)
			Winform::upecino->Detener();
		else if (e->KeyCode == Keys::A || e->KeyCode == Keys::Left && Winform::upecino->direccion == Izquierda)
			Winform::upecino->Detener();
		else if (e->KeyCode == Keys::D || e->KeyCode == Keys::Right && Winform::upecino->direccion == Derecha)
			Winform::upecino->Detener();
